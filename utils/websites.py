...
def get_ikea_product_info(url, soup, base_currency, target_currencies, enable_conversion):
...
def get_elgiganten_product_info(url, soup, base_currency, target_currencies, enable_conversion):
...
def get_trademax_product_info(url, soup, base_currency, target_currencies, enable_conversion):
